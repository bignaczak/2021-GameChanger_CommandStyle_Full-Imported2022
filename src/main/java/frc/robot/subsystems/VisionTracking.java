...
public class VisionTracking extends SubsystemBase {
  ...
  public boolean alignToTarget(boolean targetFound, double xError, double yError, String zone, DriveSubsystem drive){
    ...
    switch (zone){
      case "B":  yOffset = VisionConstants.kBlueOffest; break;
      case "Y":  yOffset = VisionConstants.kYellowOffset; break;
      case "R":  yOffset = VisionConstants.kRedOffset;break;
    }
